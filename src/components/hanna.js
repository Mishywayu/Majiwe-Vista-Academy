...
export default function Hanna() {
  return (
    <div>
      <div className="hanna-page">
        <div className="hanna-bio">
          <h1>About Me</h1>
          <p className="bio">
          ...
          <hr />
          <div className="hanna-profile">
            <div className="profile-left"></div>
            <div className="profile-right"></div>
          </div>
          <div className="biography">
            <h2>Hanna Nomalanga</h2>
            <p>
              <span>Experience at Majiwe Vista Academy:</span>
              <br />
              <br />
              In 2001, Hanna Nomalanga joined Majiwe Vista Academy as a
              mathematics teacher. her arrival brought a fresh perspective to
              the institution, and he soon became known for her dynamic teaching
              ...
              <br />
              <br />
              As Principal of Majiwe Vista Academy, Hanna Nomalanga has left an
              ...
              Majiwe Vista Academy into the future, Hanna Nomalanga remains
